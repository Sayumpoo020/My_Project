...
<h1 align="center">รายละเอียดใบสั่งซื้อ เลขที่ <?=$_GET['a'];?></h1>
    <a href="view_order.php"><button type="button" class="btn btn-primary"><div class="b">ย้อนกลับ</div></button></a>
    <a href="shop.php"><button type="button" class="btn btn-primary"><div class="b">กลับไปหน้าหลัก</div></button></a>
  ...
  <thead class="thead-light">
    <tr>
      ...
      <th scope="col">เบอร์โทร</th>
        ...
        <?php
            $ido = $_SESSION['aid'];
            $sql1 = "SELECT * FROM `member` WHERE `Id_m` = '{$ido}' ";
