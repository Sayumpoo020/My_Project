...
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
       <div class="a">   
      <a class="navbar-brand" href="admin_shop.php">
  ...
  <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <a href="admin_shop.php?pt=<?=$data2['pt_id'];?>" class="dropdown-item"><?=$data2['pt_name'];?></a>  
    ...
    <?php } ?>
        ...
        <li >
          <a href="manage.php"><button type="button" class="btn btn-primary"><div class="b">จัดการสินค้า</div></button></a>
        </li>
          
          &nbsp; 
           &nbsp; 
        <li >
          <a href="admin_view_order.php"><button type="button" class="btn btn-primary"><div class="b">จัดการออเดอร์ลูกค้า</div></button></a>
        </li>
          
          &nbsp; 
           &nbsp; 
        <li >
          <a href="showmember.php"><button type="button" class="btn btn-primary"><div class="b">รายชื่อลูกค้า</div></button></a>
        </li>
      </ul>
         ...
         <div class="b">ชื่อผุ้ใช้งาน : Admin <?=$_SESSION['aname']?></div>
        </li >
              &nbsp; 
              &nbsp; 
            <li >
