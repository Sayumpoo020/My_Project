...
?>
  ...
  <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <?php } ?>
        ...
        <li >
          <a href="add_item.php"><button type="button" class="btn btn-primary"><div class="b">เพิ่มสินค้า</div></button></a>
        </li>
      </ul>
...
<div class="a"><h2 style="background-color:dimgray" align="center"> ระบบจัดการสินค้า</h2></div>
<p>
  ...
  <div class="col-md-4">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <a href="correct.php?id=<?=$data['p_id']?>" class="btn btn-primary" role="button">แก้ไข </a> |
        <a href="del.php?id=<?=$data['p_id']?>" class="btn btn-primary" role="button"> ลบ</a>
    </div>
  </div>
<?php 
		if ( ($i % 3 ) == 0){
